...
import com.CQ.AiWenDaPinTai.model.dto.userAnswer.UserAnswerAddRequest;
import com.CQ.AiWenDaPinTai.model.dto.userAnswer.UserAnswerEditRequest;
import com.CQ.AiWenDaPinTai.model.dto.userAnswer.UserAnswerQueryRequest;
import com.CQ.AiWenDaPinTai.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.CQ.AiWenDaPinTai.model.vo.UserAnswerVO;
import com.CQ.AiWenDaPinTai.scoring.ScoringStrategyExecutor;
import com.CQ.AiWenDaPinTai.service.AppService;
import com.CQ.AiWenDaPinTai.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    @Resource
    private AppService appService;   // region 增删改查
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if(!ReviewStatusEnum.getEnumByValue(app.getReviewStatus()).equals(ReviewStatusEnum.PASS)){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"应用未通过审核,用户不能答题");
        }
        // todo 填充默认值
        ...
        try {
            userAnswerWithResult.setResultId(9L);
            //null
