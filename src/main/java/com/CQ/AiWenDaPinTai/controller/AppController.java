...
import com.CQ.AiWenDaPinTai.common.*;
...
import com.CQ.AiWenDaPinTai.model.dto.app.AppAddRequest;
import com.CQ.AiWenDaPinTai.model.dto.app.AppEditRequest;
import com.CQ.AiWenDaPinTai.model.dto.app.AppQueryRequest;
import com.CQ.AiWenDaPinTai.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> reviewApp(@RequestBody ReviewRequest ReviewRequest, HttpServletRequest request) {
        ...
        ReviewStatusEnum enumByValue = ReviewStatusEnum.getEnumByValue(ReviewRequest.getReviewStatus());
        ...
        //重置审核状态
        oldapp.setReviewStatus(ReviewRequest.getReviewStatus());
        //操作数据库
        User loginUser = userService.getLoginUser(request);
        App app = new App();
